...
namespace api.Controllers
{
    ...
    public async Task<IActionResult> GetData([FromQuery] CorrelationRequestDto request)
    {
        ...
        var data = await _correlationRepository.FetchData(request.FirstModel, request.StartTime, request.EndTime, request.XAttribute, request.YAttribute).ConfigureAwait(false);

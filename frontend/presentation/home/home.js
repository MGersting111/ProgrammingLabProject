...
function createDashboard() {
  const dashboarUrl = "http://localhost:3000/dashboard";
  fetch(dashboarUrl)
    ...
    .then((data) => {
      ...
      var avgRevenue = document.getElementById("avgRevenue");
      var totalRevenue = document.getElementById("totalRevenue");
      var topProducts = document.getElementById("topProducts");
      var topStores = document.getElementById("topStores");
      avgSales.innerHTML += data[0].avgSales;
      totalSales.innerHTML += data[0].totalSales;
      avgRevenue.innerHTML += data[0].avgRevenue;
      totalRevenue.innerHTML += data[0].totalRevenue;
      topProducts.innerHTML += data[0].topProducts;
      topStores.innerHTML += data[0].topStores;
    })
    .catch((error) => {
